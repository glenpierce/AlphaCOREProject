--[[
    ...
    Note:
    - Block ability broadcasts events to BlockAbilityDisplayClient that is located in Hierarchy.
    ...
    7. Finally, move the spawn point where you want the player to start the game.
